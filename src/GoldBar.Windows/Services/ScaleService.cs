...
/// 
/// Optimized with larger serial buffers for better performance on high baud rates.
/// </summary>
public sealed class ScaleService : IDisposable
{
        ...
        ParseStopBits(s.StopBits))
    {
        ...
        RtsEnable = false,
        NewLine = "\r\n",
        ReadBufferSize = 8192,  // Increased from 4096 for better performance
        WriteBufferSize = 4096, // Increased from 2048 for better performance
